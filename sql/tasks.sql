...
insert into tasks(worker, task_venue, task_type, task_receptacle, task_receptacle_url, completion_date, payment, topic, format, notes) values
  ...
  ('Sebastian Sanchez','Timelines wiki','Wiki page update','Multiple pages','N/A','2017-04-23',50,'Health','Timeline','Adding images that were present on the Wikipedi pages: Timeline of Chagas disease: 2, Timeline of hepatitis: 10, Timeline of typhus: 4, Timeline of yellow fever: 2, Timeline of influenza: 1, Timeline of plague: 5, Timeline of poliomyelitis: 2, Timeline of measles: 1, Timeline of healthcare in Germany: 1, Timeline of healthcare in Japan: 1, Timeline of healthcare in India: 1, Timeline of healthcare in Ethiopia: 1, Timeline of leukemia: 1, Timeline of healthcare in China: 1, Timeline of malaria: 4, Timeline of tuberculosis: 1'),
