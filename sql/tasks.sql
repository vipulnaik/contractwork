...
insert into tasks(worker, task_venue, task_type, task_receptacle, task_receptacle_url, completion_date, payment, topic, format, notes) values
  ...
  ('Issa Rice','Wikipedia Views','Consulting','https://stackoverflow.com/questions/39261867/php-mysql-fixing-utf8-text-corrupted-by-implicit-mysqliset-charsetlatin1','PHP/MySQL: Fixing utf8 text corrupted by implicit mysqli::set_charset(latin1) connection','2017-01-25',20,'Character encoding issues','Private communication','Investigated character encoding issue, discovered relevant Stack Overflow question');
# -- insert into tasks(worker, task_venue, task_type, task_receptacle, task_receptacle_url, completion_date, payment, topic, format, notes) values
