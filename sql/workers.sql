...
insert into workers(worker, country, wikipedia_username, facebook_username, email_id, preferred_payment_method, recruiter, contact_method, notes, worker_file) values 
  ('Milo King','United States','MiloJBKing','milo.king','milo.j.king@gmail.com','PayPal','Vipul Naik','outbound Facebook','Did a bit of Wikipedia work in March and then a lot of work on the Market subwiki in the summer of 2016','milo-list.mediawiki'),
  ('Issa Rice','United States','Riceissa','riceissa','riceissa@gmail.com','Check','Vipul Naik','outbound Facebook','Been working sporadically since 2015; started working regularly since early 2016. Recruited other workers and also helps with managing workers and sprints.', 'issa-list.mediawiki'),
  ...
  ('Ethan Bashkansky','United States','Ethanbas','ethan.bashkansky','ethanbas@gmail.com','PayPal','Issa Rice','outbound in-person','Did sporadic work in February, and has done sporadic work a few times since. Also recruits other workers and stays in touch.','ethan-list.mediawiki'),
  ('Adrian Ulloa','Peru','Physikite','physikite','physikite@outlook.com','PayPal','Vipul Naik','inbound email','Did sporadic work in September of 2016.','adrian-list.mediawiki'),
  ('Avi Glozman','United States','Avigl','avi.glozman','avi.glozman@gmail.com','PayPal','Ethan Bashkansky','outbound Facebook','Sporadic work since late May/early June 2016','avi-list.mediawiki'),
  ('Charlie Corner','United States','Churrupy','charlie.corner.5','churrupy@gmail.com','PayPal','Linchuan Zhang','inbound Facebook','Sporadic work since late June/early July 2016','charlie-list.mediawiki'),
  ('Christopher Kunin','United States','ChristopherLKunin','chris.kunin.5','Chris.kunin@me.com','PayPal','Ethan Bashkansky','outbound Facebook','Sporadic wok since June 2016','chris-list.mediawiki'),
  ('Devansh Dwivedy','United States','Dave8033','devansh33','devarshi@yahoo.com','PayPal','Ethan Bashkansky','outbound Facebook','Sporadic work since June 2016. Note that PayPal belongs to his father','devansh-list.mediawiki'),
  ('Eddy Su','United States','Esu44224','EddySu98008','esu44224@gmail.com','PayPal','Ethan Bashkansky','outbound Facebook','Made two Wikipedia articles in June 2016.','eddy-list.mediawiki'),
  ('Jesse Clifton','United States','JesseClifton','jesse.clifton2','jclifton333@gmail.com','Check','Vipul Naik','inbound Facebook','Introduced by Jacy Reese; Jesse had done a project for Jacy at Animal Charity Evaluators and had a summer off','jesse-list.mediawiki'),
  ('Michael Royzen','United States','Rushingcreek','michael.royzen','michael@mlabtechnologies.com','PayPal','Ethan Bashkansky','outbound Facebook','Wrote one article in June 2016 but could not work further as he wanted to spend more time on developing his app.','michael-list.mediawiki'),
  ('Sean Yu','United States','Majesticfish','sean.yu.18','yusean1792@gmail.com','PayPal','Ethan Bashkansky','outbound Facebook','A little work on tax forms in July 2016.','sean-list.mediawiki'),
  ('Sergey Yegorov','Russia','Sergie_Marienhof','avereflection','sashspecial@gmail.com','PayPal','Vipul Naik','inbound Facebook','Sporadic work since September 2016.','sergey-list.mediawiki'),
  ('Thomas Foster','Australia','Thomas_James_Foster','thomasjamesfoster96','me@thomasfoster.co','PayPal','Alex K. Chen','outbound Facebook','Work in June 2016. Could not continue as school term started.','thomas-list.mediawiki'),
  ...
  ('Joey Malandra','United States','Joeykai','joey.malandra.73','joseph.malandra@gmail.com','PayPal','Ethan Bashkansky','outbound Facebook','Introduced to Ethan through a mutual friend Ethan met at the Envision Conference. Had 58K edits at the time.','joey-list.mediawiki');
