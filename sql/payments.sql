create table payments(
  ...
  payment_method enum('Cash','Check','PayPal','Wire transfer','Western Union','Debit card via Facebook','Venmo','Ethereum','Bitcoin','Bitcoin Cash','Direct deposit via Gusto','Direct deposit','FTX','Undisclosed') not null,
  ...
  notes varchar(2000),
  check(sent_payment = received_payment + overhead),
...
insert into payments(payment_method, payee, intermediary, sent_date, payment_notice_receipt_date, cashout_request_date, receipt_date, payment, sent_payment, overhead, received_payment, notes) values
  ...
  ('FTX','Sebastian Sanchez',null,'2025-05-30','2025-05-30','2025-05-30','2025-05-30',7500,7500,0,7500,'This was the return of $7,500 in Future Fund Regranting Program payments that were lost in the FTX portal in November 2022 due to the collapse of FTX.'),
  ('Bitcoin','Sebastian Sanchez',null,'2025-06-02','2025-06-02','2025-06-02','2025-06-02',4216.45,4216.63,0.18,4216.45,'Funds sent and received Monday, June 2, 2025 (in Pacific Time; Vipul was in India so it was Tuesday June 3 in his timezone). Transaction in Bitcoin for 0.04 BTC (and calculated in terms of USD value at time of transaction of $105411.30 per BTC) with a very small transaction fee of 0.00000169 BTC ($0.18 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/37062b6e2120164d4b2062b75d9b72f191ac76716da336807d76e57aa5c2d7aa (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously; the transaction of interest is number 31 on the list).'),
  ('Bitcoin','Sebastian Sanchez',null,'2025-12-01','2025-12-01','2025-12-01','2025-12-01',4332.08,4332.59,0.51,4332.08,'Funds sent and received Monday, December 1, 2025. Transaction in Bitcoin for 0.05 BTC (and calculated in terms of USD value at time of transaction of $86641.61 per BTC) with a very small transaction fee of 0.00000588 BTC ($0.51 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/d4e3239f5188c272dfe8c59f653e6774a6127f8907b7f85bfb477ced330979fb (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously; the transaction of interest is number 8 on the list).'),
  ('Bitcoin','Sebastian Sanchez',null,'2026-05-03','2026-05-03','2026-05-03','2026-05-03',3936.24,3936.59,0.35,3936.24,'Funds sent and received Sunday, May 3, 2026. Transaction in Bitcoin for 0.05 BTC (and calculated in terms of USD value at time of transaction of $78724.86 per BTC) with a very small transaction fee of 0.00000441 BTC ($0.35 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/1ba27c103b9b6b50ef22fcda66797d4e36b8d4eacf4deadfb5e26d1309fa1eb2 (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously; the transaction of interest is number 24 on the list).'),
  ('Bitcoin','Sebastian Sanchez',null,'2026-07-21','2026-07-21','2026-07-21','2026-07-21',3314.76,3315.05,0.29,3314.76,'Funds sent and received Tuesday, July 21, 2026. Transaction in Bitcoin for 0.05 BTC (and calculated in terms of USD value at time of transaction of $66295.15 per BTC) with a very small transaction fee of 0.00000441 BTC ($0.29 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/3e2532f23da4124e016f1f04ab27142115eb80c726a50d44265b34e9464519b7 (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously; the transaction of interest is number 15 on the list).'),
  ...
  ('Bitcoin','Gabriel Bobis',null,'2024-12-05','2024-12-05','2024-12-05','2024-12-05',2024.26,2025.83,1.57,2024.26,'Transaction in Bitcoin for 0.02 BTC (and calculated in terms of USD value at time of transaction of $101,212.91 per BTC) with a small transaction fee of 0.00001553 BTC ($1.57 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/ff98877d298983cac4f0950152f1132128cd782d665cb47e28ddc92aef8b8980 (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously, so its details are a bit misleading; the transaction of interest is at number 26).'),
  ('Bitcoin','Gabriel Bobis',null,'2025-05-14','2025-05-14','2025-05-14','2025-05-14',2064.95,2065.45,0.50,2064.95,'Transaction in Bitcoin for 0.02 BTC (and calculated in terms of USD value at time of transaction of $103,247.46 per BTC) with a small transaction fee of 0.00000485 BTC ($0.50 USD). Transaction available online at https://www.blockchain.com/explorer/transactions/btc/04ac25e2bd722a74b5f776e4aff1c6cffdf8e1f82cfb7773ca9ee0eb08860b9a (note that the transaction as shown in Blockchain appears to bundle this transaction with others that Coinbase may have executed simultaneously, so its details are a bit misleading; the transaction of interest is at number 11).'),
  ...
  ('PayPal','Olivia Mora',null,'2024-12-04','2024-12-04','2024-12-04','2024-12-04',410.20,410.20,0,410.20,'Clearing out payments due for November 2024'),
  ('PayPal','Olivia Mora',null,'2024-12-31','2024-12-31','2024-12-31','2024-12-31',597.80,597.80,0,597.80,'Clearing out payments due for December 2024; this is the final month of Olivia''s work so this is the final payment.'),
  ...
  ('PayPal','Reagan Sang',null,'2024-12-01','2024-12-01','2024-12-01','2024-12-01',798,798,4.99,793.01,'Clearing out payments due for November 2024'),
  ...
  ('Wire transfer','Hithheshwar',null,'2025-01-13','2025-01-15','2025-01-15','2025-01-15',2226,2226,15,2211,'The wire transfer was scheduled on 2025-01-12 (Sunday) but domestic wires can only be sent on working days, so the send date was set to 2025-01-13. This clears out all pending dues and is the final payment to Hith.'),
  ...
  ('Wire transfer','Tajudeen Riliwan',null,'2025-01-12','2025-01-14','2025-01-14','2025-01-14',301.23,301.23,0,301.23,'Clearing out payments due for December 2024'),
  ...
  ('Wire transfer','Tajudeen Riliwan',null,'2025-06-02','2025-06-02','2025-06-02','2025-06-02',214.90,214.90,0,214.90,'Clearing out payments due for May 2025');
