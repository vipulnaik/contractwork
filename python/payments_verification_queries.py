...
queries = [
    ...
    "select * from payments where payee in ('Sebastian Sanchez','Gabriel Bobis') and sent_date >= '2020-06-02' and not (payment_method in ('Bitcoin','FTX','Bitcoin Cash') or (sent_date = '2025-06-02' and payment_method = 'Undisclosed'));",
]
